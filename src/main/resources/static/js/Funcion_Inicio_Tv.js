	...
	if (message.length >= 6) {
		...
		for (var i = 0; i < 6; i = i + 2) {
			if (message.length % 2 == 0) {
				const con = new String("<div class='row'><div class='sec_1 col " + this.color(message[i]) + "'><h2> " + this.showValue(message[i].reservacion_n_id_reservacion.cliente_n_id_cliente.s_codigo_letra_cliente, message[i].reservacion_n_id_reservacion.cliente_n_id_cliente.n_codigo_cliente, message[i].ventanilla_n_id_ventanilla.n_numero_ventanilla) + "</h2></div><div class='sec_1 col " + this.color(message[i + 1]) + "'><h2> " + this.showValue(message[i + 1].reservacion_n_id_reservacion.cliente_n_id_cliente.s_codigo_letra_cliente, message[i + 1].reservacion_n_id_reservacion.cliente_n_id_cliente.n_codigo_cliente, message[i + 1].ventanilla_n_id_ventanilla.n_numero_ventanilla) + "</h2></div></div>");
				dato = dato + con;
			} else {
				if (i == message.length - 1) {
					const con = new String("<div class='row'><div class='sec_1 col " + this.color(message[i]) + "'><h2> " + this.showValue(message[i].reservacion_n_id_reservacion.cliente_n_id_cliente.s_codigo_letra_cliente, message[i].reservacion_n_id_reservacion.cliente_n_id_cliente.n_codigo_cliente, message[i].ventanilla_n_id_ventanilla.n_numero_ventanilla) + "</h2></div></div>");
					dato = dato + con;
				} else {
					const con = new String("<div class='row'><div class='sec_1 col " + this.color(message[i]) + "'><h2> " + this.showValue(message[i].reservacion_n_id_reservacion.cliente_n_id_cliente.s_codigo_letra_cliente, message[i].reservacion_n_id_reservacion.cliente_n_id_cliente.n_codigo_cliente, message[i].ventanilla_n_id_ventanilla.n_numero_ventanilla) + "</h2></div><div class='sec_1 col " + this.color(message[i + 1]) + "'><h2> " + this.showValue(message[i + 1].reservacion_n_id_reservacion.cliente_n_id_cliente.s_codigo_letra_cliente, message[i + 1].reservacion_n_id_reservacion.cliente_n_id_cliente.n_codigo_cliente, message[i + 1].ventanilla_n_id_ventanilla.n_numero_ventanilla) + "</h2></div></div>");
					dato = dato + con;
